...
\paragraph{Se connecter} Ce sont les respos bar qui doivent rentrer les comptes des membres de la section dans le logiciel bar. Ils prendront la convention suivante pour tes identifiants de connexion initiaux :
\begin{description}
...
\begin{itemize}
	\item le respo appro aura accès au menu \menu{Administration>Aliments} ;
	\item le respo news aura accès au menu \menu{Administration>Actualités} ;
	\item le trézobar aura accès au menu \menu{Administration>Comptabilité}.
\end{itemize}
