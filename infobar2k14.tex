...
\paragraph{Signaler un bug} En cliquant sur \menu{Signaler un bug}, tu peux envoyer un message à l'équipe de développement de Chocapix qui s'empressera de corriger l'erreur si jamais tu donnes des informations assez précises sur la nature du bug. Utilise cette fonction pour que le site bar soit encore mieux !
